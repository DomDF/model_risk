...
class CounterfactualAnalyzer:
    ...
    """
    def __init__(self, model, label_mapping, learning_rate=1, steps=1000):
        """
...
def perform_counterfactual(model, image_path, source_class, target_class, 
                          learning_rate=1, steps=1000, save_dir = "counterfactual_results"):
    """
...
def analyze_and_visualize(model, image_path, true_class_name, save_dir=None, learning_rate=1, steps=1000):
    """
...
def perform_counterfactual_analysis(model, image, source_class, target_class, 
                                  steps=1000, learning_rate=1.0, save_dir="counterfactual_results"):
    """
...
def run_counterfactual_analysis(model, source_class, target_class, base_dir="DB - Copy",
                             steps=1000, learning_rate=1.0, temperature=None):
